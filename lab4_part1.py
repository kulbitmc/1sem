...
text2 = f1.render("ENTER YOUR NAME", 0, (0, 180, 0))
...
def new_target(N):
    """
    Функция new_target рисует N мишеней.
    :param N: количество мишеней
    """
...
def respawn_target(i):
    """
    Функция respawn_target создаёт новую мишень взамен "убитой" старой.
    :param i: номер воссоздаваемой мишени.
    """
